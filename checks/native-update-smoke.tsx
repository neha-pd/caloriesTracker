...
export default function Smoke() {
 ...
 useEffect(()=>{void (async()=>{
   ...
   global.fetch=(async()=> { if (used) throw Error('offline fixture'); return {ok:true,json:async()=>({android:{version:'9.0.0',required:true,url:'https://github.com/neha-pd/caloriesTracker/releases/download/v9.0.0-team.1/FitLens-9.0.0-team-arm64.apk'}})} as Response; }) as typeof fetch;
   setReady(true);
 })()},[]);
